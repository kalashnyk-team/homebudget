...
<div class="wrapper">
    <form class="form-signin" action="j_spring_security_check" method="post">
        ...
        <label class="checkbox">
            <input class="form-control" type="checkbox" value="remember-me" id="rememberMe" name="remember-me"> Remember me
        </label>
        <button class="btn btn-lg btn-primary btn-block" type="submit">Login</button>
        <h2 class="form-signin-heading">OR signin as demo-user</h2>
        <button onclick="demoUser()" class="btn btn-lg btn-primary btn-block">Login as demo-user</button>
    </form>
</div>
